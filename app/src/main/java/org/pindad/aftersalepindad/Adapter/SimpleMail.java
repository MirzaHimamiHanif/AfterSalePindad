...
public class SimpleMail extends javax.mail.Authenticator{
    ...
    public SimpleMail() {
        _host = "smtp.pindad.com"; // default smtp server
        _port = "465"; // default smtp port
        _sport = "465"; // default socketfactory port

        _user = "tester2"; // username
        _pass = "aftersales123"; // password
        _from = "tester2@pindad.com"; // email sent from
        _subject = "Tes"; // email subject
        _body = "Tes"; // email body
    ...
    public SimpleMail(String user, String pass) {
        this();
